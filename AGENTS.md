...
- **Slice-claim on IN_PROGRESS** — [spec 049](docs/specs/049-slice-claim-on-in-progress/spec.md) — `transition ... IN_PROGRESS` stamps `claimed_by:` + refuses foreign claims; local by default.
...
- **SPIDR**, **Vertical slice**, **Dumb zone**, **Reconciliation**, **Tier 0/1/2**, **Hot Cache** — see [glossary](docs/memory/glossary.md) / `/jig:explain`.
