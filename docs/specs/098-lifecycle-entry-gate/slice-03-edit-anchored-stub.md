...
## Slice 098-03 — edit-anchored capture stub (DEFERRED)

**Goal:** The same out-of-lifecycle edit that triggers slice 098-01's nudge also
...
**Why it is a separate slice, not part of 098-01:** 098-01 is correct and
...
and risks (dedup fate, host parity). Keeping them separate keeps 098-01
revertable and unblocked.

**When un-deferred, acceptance will cover (sketch, not binding):**
- The 098-01 trigger additionally writes one stub in the format the capture-rewrite
...
- Additive and fail-open: a stub-write failure never affects the 098-01 nudge or
  the session.
