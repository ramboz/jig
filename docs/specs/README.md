...
| [016-scaffold-mode](016-scaffold-mode/spec.md) | 016-01 — copy-skills-and-agents | RECONCILED | Positioning-recovery (audit-stage): give devs editable in-repo machinery |
| [016-scaffold-mode](016-scaffold-mode/spec.md) | 016-02 — copy-hooks-and-register | DRAFT | Generates `.claude/settings.json` w/ jig hook registration |
