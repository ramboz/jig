...
| [003-spec-workflow-promotion](003-spec-workflow-promotion/spec.md) | 003-03 — reserve-spec-on-main | READY_FOR_REVIEW | Revived from "new-spec-scaffolding"; reserve next free spec number on origin/main with PR fallback |
