...
- [x] `docs/specs/README.md` regenerated by `workflow.py status-board`. **29 slices across 9 specs; 008-05 row shows DONE.**
- [x] `CLAUDE.md` Active-specs entry for spec 008 updated to reflect
