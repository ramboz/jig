...
- [x] `docs/specs/README.md` regenerated by `workflow.py status-board`.
      _(Notes curated to match 012-01 / 022-01 shape.)_
- [x] `CLAUDE.md` updates: hot-cache entry for spec 023-01;
      Skills table row added; sprint-focus refresh.
      _(Added 023-clarify Active-specs entry; new `/jig:clarify`
      Skills-table row; new "Spec-kit gap closure (2026-05-18)"
      sprint-focus paragraph.)_
- [x] `docs/product-vision.md` "Tier 1 — default-on" list updated
      to include `clarify` (now eight entries — also reflects
      `contracts` from spec 022 and `analyze` from spec 024
      landing in the same merge). Principle 5 updated to
