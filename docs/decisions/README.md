...
- [ADR-0039: Enforce ADR-vs-lightweight routing with a two-signal deliberateness gate](adr-0039-decision-routing-gate.md) — [ADR-0031](adr-0031-load-bearing-decision-adr-trigger.md) fixed the *wording* of the Architectural Decision Record (ADR) trigger and single-sourced it as `decisions.py:ADR_TRIGGER`. (2026-07-22, Proposed)
