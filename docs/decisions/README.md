...
- [ADR-0045: Slice Claim Covers Active Lifecycle](adr-0045-slice-claim-covers-active-lifecycle.md) — `claimed_by:` is jig's only machine-readable "a session is working here" signal. (2026-07-24, Proposed)
