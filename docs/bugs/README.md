...
| 013 | slice-claim-covers-only-in-progress | medium | gnarly | DONE | yes | skills/spec-workflow/test_workflow.py::Bug013WidenedClaimTests | claude/issue-130-jig-bugfix-57198e |  |  |
