...
[spec 016-scaffold-mode](../specs/016-scaffold-mode/spec.md). **Opt-in as of slice 096-01 /
[ADR-0039](../decisions/adr-0039-scaffold-defaults-to-plugin-mode.md)** — pass `--in-repo`
...
jig installed, archival repos. It was default-on between slices 016-03 and 096-01. When
