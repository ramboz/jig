...
- 002-memory-layer: slices 002-01 and 002-02 **DONE**; 002-03 (auto-detect-hooks) next
...
| `/jig:memory-sync` | Slices 002-01, 002-02 DONE (write + lookup); 002-03, 002-04 pending | Yes (explicit) |
