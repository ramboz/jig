...
### Active specs
- 001-scaffold-init: Spike 001a + slices 001-01..001-03 **DONE**; slice 001-04 (deferred-decisions) next
...
|---|---|---|
| `/jig:scaffold-init` | Slices 001-01..001-03 DONE; 001-04, 001-05 pending | Yes (explicit) |
