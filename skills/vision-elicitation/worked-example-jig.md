...
fixed-size opinionated workflow layer (5 Tier 0 + ~5 Tier 1 skills,
...
**User answers:**
- Core features: scaffold-init, memory-sync, spec-workflow, independent-review, migrate (Tier 0); adr-workflow, tdd-loop, slice-land, pr-review, arch-review (Tier 1); local-dev-parity (Tier 2, deferred)
