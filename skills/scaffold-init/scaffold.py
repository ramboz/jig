...
# Watermark embedded in the scaffolded CLAUDE.md template — its presence
# means "this CLAUDE.md was generated by jig", which is how we distinguish
# a jig-partial state (crashed mid-scaffold, no scaffold.json) from a
# user's pre-existing spec-driven project. Slice 032-02: used by
...
def _is_jig_partial_state(target: Path) -> bool:
    ...
    scaffold (CLAUDE.md exists with the jig watermark, but scaffold.json
    ...
    Reads CLAUDE.md best-effort — any I/O failure returns False (the
