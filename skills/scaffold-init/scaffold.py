...
def scaffold(target: Path, plugin: Path, *, force: bool = False,
    ...
    #
    # Slice 099-01 (ADR-0041 OQ3): Codex is mode-gated too. It always needs
    # SOME transform — its docs must never speak Claude — but *which* runtime
    # root they name depends on the mode, exactly as it does for Claude. Under
    ...
    # project's AGENTS.md and docs/workflow.md cited a `.codex/skills/` tree
    # the scaffold never created.
    if host == "codex":
        doc_rewrite = (
