...
(which reads the updated STATUS marker) or primer hot-cache hygiene
(which advertises the slice as done). These items create a
...
- [ ] `AGENTS.md` / `CLAUDE.md` hot-cache hygiene.
```
